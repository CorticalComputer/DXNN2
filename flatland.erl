...
create_turret()->
	%Put into a particular corner of the map (where food is).
	%Ensure that it does not intersect with the food.
	%Infinite weight (can't be pushed), shoots at a rate of at most 1/100 moves (the faster you are...).
	ok.
	
create_bullet()->
	%generated by the turret or agent.
	%Sent in the trajectory of the pointing vector.
	%Speed should be 5/step, range before disapeerance 100, R=1
	ok.
